 ...
 */
public class SlaveHTabController extends MilkTabControleur {

    
    @FXML
    private ComboBox<SlaveHuman> selectVar;
	...
	public void initialize() {
    	...
    	selectVar.setItems(SlaveListH.getInstance().getSHFullListe());
	...
	public void changeVar(SlaveHuman milkVar) {
		if(milkVar!=null){
